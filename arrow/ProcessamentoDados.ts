...
let numerosMiorque9 = numerosRepetidos.find( n => n > 9);
console.log(numerosMiorque9);
 
console.log("\nfindIndex() - Encontrar o Índice do primeiro número da lista maior do que 9\n");

let indiceNumerosMiorque9 = numerosRepetidos.findIndex( n => n > 9);
console.log(indiceNumerosMiorque9);
